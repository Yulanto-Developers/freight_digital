          ...
          <div className="grid md:grid-cols-2 grid-cols-1 items-center lg:gap-24 gap-5">
            ...
            >
              ...
              <p className="text-lg font-normal text-justify text-[#58595B] dark:text-opacity-90 max-w-506 md:pt-3 pt-5 md:pb-10 pb-6">
                Freight Digital is a specialized  marketing partner  dedicated exclusively to the freight forwarding, logistics, shipping, and supply chain industry. We help freight forwarders, customs brokers, NVOCCs, transport operators, and logistics service providers strengthen their digital presence, enhance brand visibility, and generate new business opportunities worldwide.
              </p>
              <Link
                href="/about"
